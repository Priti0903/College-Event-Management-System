        ...
        <div class = "content"><!--body content holder-->
            ...
            <div class="container">
                <div class="col-md-6 contacts">
                    ...
                    <p>
                        <span class="glyphicon glyphicon-envelope"></span> Email: aka51103y@gmail.com<br>
    
                        <span class="glyphicon glyphicon-phone"></span> Mobile: 9637569051
                    </p>
                </div>
                <div class="col-md-6 contacts">
                    <h1 style="color:#000080 ; font-size:42px ; font-style:bold "><span class="glyphicon glyphicon-user"></span> Example</h1>
                    <p>
                        <span class="glyphicon glyphicon-envelope"></span> Email: pritiv.8211@gmail.com<br>
    
                        <span class="glyphicon glyphicon-phone"></span> Mobile: 9689744822
                    </p>
                </div>
            </div>
